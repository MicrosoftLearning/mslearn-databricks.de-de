...
1. Verwenden Sie unter der Ausgabe für die erste Zelle das Symbol **+ Code**, um eine neue Zelle hinzuzufügen. Führen Sie dann den folgenden Code darin aus, um einen Stream auf der Grundlage des Ordners mit den JSON-Gerätedaten zu erstellen:
