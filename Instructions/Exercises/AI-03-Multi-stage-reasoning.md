...
1. Wählen Sie im linken Fensterbereich unter **Ressourcenverwaltung** die Option **Tasten und Endpunkt**.

1. Kopieren Sie den Endpunkt und einen der verfügbaren Schlüssel, da Sie ihn später in dieser Übung verwenden werden.
...
1. Melden Sie sich beim **Azure-Portal** unter `https://portal.azure.com` an.
1. Erstellen Sie eine **Azure Databricks**-Ressource mit den folgenden Einstellungen:
...
1. Wählen Sie **Überprüfen + Erstellen** und warten Sie, bis die Bereitstellung abgeschlossen ist. Wechseln Sie dann zur Ressource, und starten Sie den Arbeitsbereich.
...
1. Wählen Sie Ihre Azure Databricks Service-Ressource aus.
...
1. Führen Sie in einer neuen Zelle den folgenden Code aus, um ein QA-System mit dem Retriever und dem Modell `gpt-4o` zu erstellen:
